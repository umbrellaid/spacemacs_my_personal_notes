...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("IntoneMono Nerd Font"
                               :size 18.0
                               :weight normal
                               :width normal)
...
before packages are loaded."
  (with-eval-after-load 'org
    ...
    (setq org-directory "/Users/davidrecor/Downloads/org-notes")
    ;; Optionally, you can set the default agenda files to include all Org files in that directory
